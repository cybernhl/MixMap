...
public class BathymetryActivity extends AppCompatActivity implements OnMapReadyCallback {
  private final static String TAG = "BathymetryActivity";
  ...
  public void onMapReady(MapboxMap mapboxMap) {
    ...
    com.mapbox.mapboxsdk.geometry.LatLngBounds mapBounds = mapboxMap.getProjection().getVisibleRegion().latLngBounds;
    Log.d(TAG, "Show NorthEast : " + mapBounds.getNorthEast());
    Log.d(TAG, "Show NorthWest : " + mapBounds.getNorthWest());
    Log.d(TAG, "Show SouthEast : " + mapBounds.getSouthEast());
    Log.d(TAG, "Show SouthWest : " + mapBounds.getSouthWest());

    Log.d(TAG, "Show LatNorth : " + mapBounds.getLatNorth());
    Log.d(TAG, "Show LatSouth : " + mapBounds.getLatSouth());
    Log.d(TAG, "Show LonEast : " + mapBounds.getLonEast());
    Log.d(TAG, "Show LonWest : " + mapBounds.getLonWest());


    Log.d(TAG, "Show farLeft : " + mapboxMap.getProjection().getVisibleRegion().farLeft);
    Log.d(TAG, "Show farRight : " + mapboxMap.getProjection().getVisibleRegion().farRight);
    Log.d(TAG, "Show nearLeft : " + mapboxMap.getProjection().getVisibleRegion().nearLeft);
    Log.d(TAG, "Show nearRight : " + mapboxMap.getProjection().getVisibleRegion().nearRight);
